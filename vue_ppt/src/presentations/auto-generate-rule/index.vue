...
import Slide1Intro from './slide-1-intro.vue'
import Slide2Create from './slide-2-create.vue'
import Slide3Usage from './slide-3-usage.vue'
import Slide4Demo from './slide-4-demo.vue'
import Slide5Thanks from './slide-5-thanks.vue'
...
const presentationContext = createPresentationContext({
  ...
  contextKey: 'auto-generate-rule',
  persist: true
})

providePresentationContext(presentationContext)

const title = computed(() => 'Auto-Generate-Rule · 医疗规则自动生成')
...
.deck-shell :deep(.thumbnail.active) {
  @apply border-2 border-emerald-400 bg-emerald-400/20;
}
