...
import Slide01Cover from './slides/slide-01-cover.vue'
import Slide02Toc from './slides/slide-02-toc.vue'
import Slide03WhatIsClaude from './slides/slide-03-what-is-claude.vue'
import Slide04ModelFamily from './slides/slide-04-model-family.vue'
import Slide05DividerHarness from './slides/slide-05-divider-harness.vue'
import Slide06WhatIsHarness from './slides/slide-06-what-is-harness.vue'
import Slide07HarnessValue from './slides/slide-07-harness-value.vue'
import Slide08HarnessArchitecture from './slides/slide-08-harness-architecture.vue'
import Slide09DividerCore from './slides/slide-09-divider-core.vue'
import Slide10Skills from './slides/slide-10-skills.vue'
import Slide11Memory from './slides/slide-11-memory.vue'
import Slide12Security from './slides/slide-12-security.vue'
import Slide13ExecutionLoop from './slides/slide-13-execution-loop.vue'
import Slide14DividerOpensource from './slides/slide-14-divider-opensource.vue'
import Slide15Archon from './slides/slide-15-archon.vue'
import Slide16ClaudeCodeBook from './slides/slide-16-claude-code-book.vue'
import Slide17OtherProjects from './slides/slide-17-other-projects.vue'
import Slide18Cta from './slides/slide-18-cta.vue'
...
const presentationContext = createPresentationContext({
  ...
  contextKey: 'claude-harness',
  persist: true
})

providePresentationContext(presentationContext)

const title = computed(() => 'Claude Agent Harness 深度解析')
...
const slides = [
  ...
  Slide03WhatIsClaude,
  Slide04ModelFamily,
  Slide05DividerHarness,
  Slide06WhatIsHarness,
  Slide07HarnessValue,
  Slide08HarnessArchitecture,
  Slide09DividerCore,
  Slide10Skills,
  Slide11Memory,
  Slide12Security,
  Slide13ExecutionLoop,
  Slide14DividerOpensource,
  Slide15Archon,
  Slide16ClaudeCodeBook,
  Slide17OtherProjects,
  Slide18Cta,
]
